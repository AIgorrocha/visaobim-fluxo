...
export const mockProjects: Project[] = [
  // Private Projects
  {
    ...
    description: 'Finalizar desenhos técnicos e detalhamentos estruturais',
  ...
  },
  {
    ...
    description: 'Desenvolver projeto executivo completo e aprovações',
  ...
  },
  {
    ...
    description: 'Aguardando aprovação do cliente para iniciar projeto básico',
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_BASICO',
    description: 'Concluir levantamento topográfico e estudos preliminares',
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_EXECUTIVO',
    description: 'Finalizar detalhamentos de instalações e estrutura',
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_BASICO',
    description: 'Elaborar plantas baixas e cortes arquitetônicos',
  ...
  },
  {
    ...
    status: 'EM_ESPERA',
    phase: 'ESTUDO_PRELIMINAR',
    description: 'Aguardando definições do terreno para iniciar estudos',
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_EXECUTIVO',
    description: 'Desenvolver projeto paisagístico e infraestrutura',
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_BASICO',
    description: 'Criar layout de ambientes e projeto de interiores',
  ...
  // Public Projects
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_EXECUTIVO',
    description: 'Finalizar detalhamentos técnicos e memorial descritivo',
    responsible_id: '9', // Rondinelly
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_BASICO',
    description: 'Desenvolver projeto arquitetônico e estrutural',
    responsible_id: '10', // Edilson
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_EXECUTIVO',
    description: 'Concluir projeto executivo de adequações',
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_BASICO',
    description: 'Elaborar plantas de reforma e instalações',
  ...
  },
  {
    ...
    status: 'EM_ESPERA',
    phase: 'ESTUDO_PRELIMINAR',
    description: 'Aguardando aprovação para iniciar estudos elétricos',
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_EXECUTIVO',
    description: 'Finalizar memorial de cálculo estrutural',
    responsible_id: '2', // Gustavo
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_BASICO',
    description: 'Criar projeto básico de reforma administrativa',
    responsible_id: '4', // Leonardo
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_EXECUTIVO',
    description: 'Desenvolver projeto completo de infraestrutura',
    responsible_id: '3', // Bessa
  ...
  },
  {
    ...
    status: 'EM_ESPERA',
    phase: 'ESTUDO_PRELIMINAR',
    description: 'Aguardando definições do projeto universitário',
  ...
  },
  {
    ...
    status: 'EM_ANDAMENTO',
    phase: 'PROJETO_BASICO',
    description: 'Desenvolver projeto básico de infraestrutura municipal',
    responsible_id: '5', // Pedro
