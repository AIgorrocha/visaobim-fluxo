...
-- 2. Remover TODOS os triggers da tabela tasks
...
-- 4. Remover TODAS as funções relacionadas a pontos
...
-- 11. Recriar policies básicas para a tabela tasks
...
SELECT 'FUNCOES COM POINTS:' as tipo;
SELECT routine_name
FROM information_schema.routines
WHERE routine_schema = 'public'
